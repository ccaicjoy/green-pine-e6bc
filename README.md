...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/green-pine-e6bc
```

A live public deployment of this template is available at [https://green-pine-e6bc.templates.workers.dev](https://green-pine-e6bc.templates.workers.dev)
